...
#
#*********************************************************************
ggplot(as.data.frame(acts[[11]]$ACCDMG), aes(y=acts[[11]]$ACCDMG)) + 
...
e <- ggplot(as.data.frame(acts[[1]]$ACCDMG), aes(y=acts[[1]]$ACCDMG)) + 
  geom_boxplot(col= "steelblue") + ggtitle("Total Accident Damage in 2001") +
  labs(x = "Dollars ($)") + theme(plot.title = element_text(hjust = 0.5)) + coord_flip() 
f <- ggplot(as.data.frame(acts[[4]]$ACCDMG), aes(y=acts[[4]]$ACCDMG)) + 
  geom_boxplot(col= "steelblue") + ggtitle("Total Accident Damage in 2001") +
  labs(x = "Dollars ($)") + theme(plot.title = element_text(hjust = 0.5)) + coord_flip()
g <- ggplot(as.data.frame(acts[[8]]$ACCDMG), aes(y=acts[[8]]$ACCDMG)) + 
  geom_boxplot(col= "steelblue") + ggtitle("Total Accident Damage in 2001") +
  labs(x = "Dollars ($)") + theme(plot.title = element_text(hjust = 0.5)) + coord_flip()
h <- ggplot(as.data.frame(acts[[11]]$ACCDMG), aes(y=acts[[11]]$ACCDMG)) + 
  geom_boxplot(col= "steelblue") + ggtitle("Total Accident Damage in 2001") +
  labs(x = "Dollars ($)") + theme(plot.title = element_text(hjust = 0.5)) + coord_flip()
...
i <- ggplot(as.data.frame(acts[[1]]$ACCDMG), aes(x=acts[[1]]$ACCDMG)) + 
  geom_boxplot(col= "steelblue") + ggtitle("Total Accident Damage in 2001") +
  labs(x = "Dollars ($)") + theme(plot.title = element_text(hjust = 0.5)) + coord_flip() + xlim(c(0,1.7e7)) + aes(group=1, x= , y=)
j <- ggplot(as.data.frame(acts[[4]]$ACCDMG), aes(x=acts[[4]]$ACCDMG)) + 
  geom_boxplot(col= "steelblue") + ggtitle("Total Accident Damage in 2001") +
  labs(x = "Dollars ($)") + theme(plot.title = element_text(hjust = 0.5)) + coord_flip()+ xlim(c(0,1.7e7)) + aes(group=1)
...
for(i in 1:11)
{
  ...
  if(i < 10)
  {
    assign(paste0("AccB", i), ggplot(as.data.frame(acts[[i]][,j]), aes_string(y=acts[[i]]$ACCDMG)) + 
             geom_boxplot(col= "steelblue") + ggtitle(paste("Total Accident Damage in 200", i, sep = "")) +
             labs(y = "Dollars ($)") + theme(plot.title = element_text(hjust = 0.5)) + coord_flip())
  }
  else
  {
    assign(paste0("AccB", i), ggplot(as.data.frame(acts[[i]][,j]), aes_string(y=acts[[i]]$ACCDMG)) + 
